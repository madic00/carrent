<?php 
    ...
    if(isset($_POST['btnInsertCar'])) {        
        ...
        $mainImg = $folderCar . strtolower($coverSlika['name']);

        $sekImg = $folderCar . strtolower($sekSlika1['name']);

        $sekImg2 = $folderCar . strtolower($sekSlika2['name']);

        $putanjaZaBazu = "/" . strtolower($carName) . "/" . $coverSlika['name'];

        $putanjaZaBazu1 = "/" . strtolower($carName) . "/" . $sekSlika1['name'];
