              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <?php
                    ...
                    $linkovi = $db->query($upit)->fetchAll();

                    foreach ($linkovi as $link): ?>

                      <!-- if(!isset($_SESSION['user']) && ($link['text'] != "Log in" && $link['text'] != "Register")): ?> -->

                        <li><a href="index.php?page=<?=$link['href']?>" class="nav-link"><?= $link['text'] ?></a></li>
